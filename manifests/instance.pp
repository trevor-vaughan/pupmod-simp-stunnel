...
define stunnel::instance(
  ...
  Simplib::Netlist                            $trusted_nets            = stunnel::instance::get_default('trusted_nets'),
  Boolean                                     $firewall                = stunnel::instance::get_default('firewall'),
  Boolean                                     $haveged                 = stunnel::instance::get_default('haveged'),
  Boolean                                     $tcpwrappers             = stunnel::instance::get_default('tcpwrappers'),
  Variant[Enum['simp'],Boolean]               $pki                     = stunnel::instance::get_default('pki'),
  Stdlib::Absolutepath                        $app_pki_dir             = "/etc/pki/simp_apps/stunnel_${name}/x509",
  String                                      $app_pki_external_source = stunnel::instance::get_default('app_pki_external_source'),
  ...
  Boolean                                     $client                  = true,
  Optional[Enum['zlib','rle']]                $compression             = stunnel::instance::get_default('compression'),
  Optional[String]                            $curve                   = stunnel::instance::get_default('curve'),
  Boolean                                     $delay                   = stunnel::instance::get_default('delay'),
  Optional[String]                            $egd                     = stunnel::instance::get_default('egd'),
  String                                      $engine                  = stunnel::instance::get_default('engine'),
  Optional[String]                            $engine_ctrl             = stunnel::instance::get_default('engine_ctrl'),
  Optional[Integer]                           $engine_num              = stunnel::instance::get_default('engine_num'),
  Optional[String]                            $exec                    = stunnel::instance::get_default('exec'),
  Array[String]                               $execargs                = stunnel::instance::get_default('execargs'),
  Enum['rr','prio']                           $failover                = stunnel::instance::get_default('failover'),
  Boolean                                     $fips                    = stunnel::instance::get_default('fips'),
  Optional[String]                            $local                   = stunnel::instance::get_default('local'),
  Optional[Simplib::URI]                      $ocsp                    = stunnel::instance::get_default('ocsp'),
  Stunnel::OcspFlags                          $ocsp_flags              = stunnel::instance::get_default('ocsp_flags'),
  Array[String]                               $openssl_cipher_suite    = stunnel::instance::get_default('openssl_cipher_suite'),
  Array[String]                               $options                 = stunnel::instance::get_default('options'),
  ...
  Boolean                                     $pty                     = false,
  Boolean                                     $renegotiation           = stunnel::instance::get_default('renegotiation'),
  Boolean                                     $reset                   = stunnel::instance::get_default('reset'),
  Boolean                                     $retry                   = stunnel::instance::get_default('retry'),
  Optional[Integer]                           $rnd_bytes               = stunnel::instance::get_default('rnd_bytes'),
  Optional[Stdlib::Absolutepath]              $rnd_file                = undef,
  Boolean                                     $rnd_overwrite           = stunnel::instance::get_default('rnd_overwrite'),
  Optional[Integer]                           $session_cache_size      = stunnel::instance::get_default('session_cache_size'),
  Optional[Integer]                           $session_cache_timeout   = stunnel::instance::get_default('session_cache_timeout'),
  String                                      $setuid                  = stunnel::instance::get_default('setuid'),
  String                                      $setgid                  = stunnel::instance::get_default('setgid'),
  Integer                                     $uid                     = stunnel::instance::get_default('uid'),
  Integer                                     $gid                     = stunnel::instance::get_default('gid'),
  Optional[String]                            $sni                     = undef,
  Array[String]                               $socket_options          = [],
  Optional[String]                            $ssl_version             = stunnel::instance::get_default('ssl_version'),
  Optional[Integer]                           $stack                   = stunnel::instance::get_default('stack'),
  String                                      $stunnel_debug           = stunnel::instance::get_default('stunnel_debug'),
  Boolean                                     $syslog                  = stunnel::instance::get_default('syslog'),
  Optional[Integer]                           $timeout_busy            = stunnel::instance::get_default('timeout_busy'),
  Optional[Integer]                           $timeout_close           = stunnel::instance::get_default('timeout_close'),
  Optional[Integer]                           $timeout_connect         = stunnel::instance::get_default('timeout_connect'),
  Optional[Integer]                           $timeout_idle            = stunnel::instance::get_default('timeout_idle'),
  Integer                                     $verify                  = stunnel::instance::get_default('verify'),
